            ...
            <div class="list">
                <div class="content-card p-3 shadow-sm rounded">
                    ...
                    <style>
                        ...
                        /* ✅ New Leave Highlight */
                        .calendar-date.leave {
                            background-color: #e1d98f !important;
                            color: #000;
                            font-weight: bold;
                            border-radius: 8px;
                        }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3 d-flex flex-wrap gap-2">
                        <button id="markPresent" class="btn btn-success">
                            <i class="fas fa-user-check me-1"></i> Mark Present
                        </button>
                        <button id="markAbsent" class="btn btn-danger">
                            <i class="fas fa-user-times me-1"></i> Mark Absent
                        </button>
                        <button id="markLeave" class="btn btn-warning text-white">
                            <i class="fas fa-plane-departure me-1"></i> Mark Leave
                        </button>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateCalendar() {
                ...
                $('.report-card-title').html(
                    `<i class="fas fa-calendar me-2"></i>${months[currentDate.getMonth()]} ${currentDate.getFullYear()}`
                );
                ...
                for (let i = 1; i <= daysInMonth; i++) {
                    ...
                    else if (status === 'leave') cls += ' leave';
            ...
            function loadLeaveData() {
                ...
                if (selectedYear === currentYear && $('#totalLeaves').text() !== '0') return;
            ...
            $('#prevMonth, #nextMonth').click(function() {
                ...
                if (currentDate.getFullYear() !== prevYear) loadLeaveData();
            });
            ...
            @if (isset($singleUserId))
                ...
                // ✅ Leave button (separate)
                $('#markLeave').click(function () {
                    const status = 'Leave';
                    $.post("{{ route('attendance.manualMark') }}", {
                        _token: "{{ csrf_token() }}",
                        date: selectedMarkDate,
