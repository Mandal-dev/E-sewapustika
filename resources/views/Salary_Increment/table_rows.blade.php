@php
    // Ensure $designation is always available (even if controller didn’t pass it)
    $designation = $designation ?? Session::get('user.designation_type');
@endphp
...
@forelse($polices as $index => $police)
    <tr>
        ...
        <td>
            @php $status = strtolower($police->salary_status); @endphp
        ...
        <td class="text-center">
            <div class="d-flex justify-content-center gap-1">
                ...
                @if ($designation === 'Head_Person' && $police->salary_increment_id && $police->salary_status === 'pending')
